...
export const EXPERIENCES = [
  ...
  },
  {
    ...
    description: `Completed Class 12 under the CBSE curriculum with 80%, specializing in PCM with IP. Gained a solid foundation in programming, problem-solving, and logical thinking through academic and personal projects.`,
    technologies: ["Python", "SQL", "Canva", "MS Office"]
  },
  {
    year: "2022",
    role: "Secondary School Graduate (10th Grade)",
    company: "Amity International School, Gurugram",
    description: `Achieved 90% in Class 10 CBSE Board Exams. Developed early interest in technology and digital tools, with initial exposure to HTML and visual design software.`,
...
export const CONTACT = {
  ...
  email: "tusharika.suman6@gmail.com",
};
